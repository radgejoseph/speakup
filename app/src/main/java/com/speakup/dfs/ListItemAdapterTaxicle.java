...
public class ListItemAdapterTaxicle extends RecyclerView.Adapter<ListItemAdapterTaxicle.ListItemHoder> implements Filterable {

    private List<ListItem> itemList;
    private List<ListItem> itemListFull;
    private OnItemListener mOnItemListener;

    public ListItemAdapterTaxicle(List<ListItem> itemList, OnItemListener onItemListener) {
    ...
    public ListItemHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_view_taxicle, null);
