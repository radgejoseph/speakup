...
public class ListItemAdapterTricycle extends RecyclerView.Adapter<ListItemAdapterTricycle.ListItemHoder> implements Filterable {

    private List<ListItem> itemList;
    private final List<ListItem> itemListFull;
    private final OnItemListener mOnItemListener;

    public ListItemAdapterTricycle(List<ListItem> itemList, OnItemListener onItemListener) {
    ...
    public ListItemHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_view_tricycle, null);
