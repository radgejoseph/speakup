...
public class ReportTaxicleActivity extends AppCompatActivity implements ListItemAdapterTaxicle.OnItemListener {
    ...
    private static final String URL_TAXICLE_LIST = "http://192.168.1.133/speakupmobile/list_taxicle.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextSearch.setFilters(new InputFilter[]{new InputFilter.LengthFilter(7)});
